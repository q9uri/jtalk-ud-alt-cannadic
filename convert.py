...
with bz2.open("./mozcdic-ut-alt-cannadic.txt.bz2", "rt", encoding="utf-8") as f:
    data = f.read()
...
Path("./build/jtalkdic-ud-alt-cannadic-ipadic.csv").write_text("\n".join(out), encoding="utf-8")
...
Path("./build/jtalkdic-ud-alt-cannadic-noacc.csv").write_text("\n".join(out), encoding="utf-8")